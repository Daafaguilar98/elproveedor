class ProductsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to products_path, notice: 'El producto fue modificado exitosamente.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:codigo, :nombre, :categoria, :marca, :precio, :foto, :url_photo)
    end
end
